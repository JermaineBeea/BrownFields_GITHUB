...
public class WorldMapper {
    ...
    public static WorldDO toWorldDO(World world){
    ...
    public static List<ObstacleDO> toObstacleDOs(World world){
    ...
    public static World fromDO(WorldDO worldDO, List<ObstacleDO> obstacleDOs){
        ...
        return new World(worldDO.getName(), worldDO.getWidth(), worldDO.getHeight(), obstacles);
    }
